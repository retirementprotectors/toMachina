...
// ============================================================================
// DEVOUR Track (ZRD-D04) — Expanded carrier format profiles
// ============================================================================
...
const CIGNA_MAPD: CarrierFormatDefinition = {
  ...
  column_map: {
    ...
    'Writing Agent': 'agent_name',
    'PBP': 'cms_plan_code',
    'Contract ID': 'cms_contract_number',
  },
  dedup_keys: ['member_id', 'carrier_id', 'effective_date'],
  header_signatures: [
    'Member ID', 'Medicare ID', 'Plan Name', 'Plan Type',
    'Effective Date', 'Premium', 'Agent NPN', 'Member Status',
  ],
  default_category: 'medicare',
}
...
const WELLCARE_MAPD: CarrierFormatDefinition = {
  ...
  column_map: {
    ...
    'Zip Code': 'zip',
    'County Name': 'county',
    'Plan Description': 'plan_name',
    'Plan Code': 'cms_plan_code',
    'Contract Number': 'cms_contract_number',
    'Enrollment Effective Date': 'effective_date',
    'Disenrollment Date': 'termination_date',
    'Member Status': 'status',
    'Status': 'status',
    'Premium Amount': 'monthly_premium',
    'Agent NPN': 'agent_npn',
    'Agent Name': 'agent_name',
    'Broker NPN': 'agent_npn',
  },
  dedup_keys: ['member_id', 'carrier_id', 'effective_date'],
  header_signatures: [
    'Member Number', 'HICN', 'Plan Description', 'Enrollment Effective Date',
    'Premium Amount', 'Agent NPN', 'Member Status', 'County Name',
  ],
  default_category: 'medicare',
}
...
const MUTUAL_OMAHA_MEDSUP: CarrierFormatDefinition = {
  ...
  dedup_keys: ['policy_number', 'carrier_id'],
  header_signatures: [
    'Policy Number', 'Insured First Name', 'Insured Last Name', 'Plan',
    'Effective Date', 'Annual Premium', 'Agent NPN', 'Policy Status',
  ],
  default_category: 'medicare',
}
...
const DEVOTED_MAPD: CarrierFormatDefinition = {
  ...
  dedup_keys: ['member_id', 'carrier_id', 'effective_date'],
  header_signatures: [
    'Member ID', 'MBI', 'Plan', 'Effective Date',
    'Enrollment Status', 'Premium', 'Agent NPN', 'County',
  ],
  default_category: 'medicare',
}
...
const NATIONWIDE_FIA: CarrierFormatDefinition = {
  ...
  column_map: {
    ...
    'Accumulation Value': 'account_value',
    'Account Value': 'account_value',
    'Cash Surrender Value': 'surrender_value',
    'NPN': 'agent_npn',
    'Agent NPN': 'agent_npn',
    'Agent Name': 'agent_name',
    'Writing Agent': 'agent_name',
  ...
  dedup_keys: ['policy_number', 'carrier_id'],
  header_signatures: [
    'Contract Number', 'Owner', 'Product Name', 'Issue Date',
    'Accumulation Value', 'Premium Received', 'NPN', 'Contract Status',
  ],
  default_category: 'annuity',
}
...
const AMERICAN_EQUITY_FIA: CarrierFormatDefinition = {
  ...
  column_map: {
    ...
    'Agent Name': 'agent_name',
    'State': 'state',
    'Surrender Period Expiry': 'maturity_date',
  },
  dedup_keys: ['policy_number', 'carrier_id'],
  header_signatures: [
    'Policy Number', 'Owner Name', 'Plan Name', 'Issue Date',
    'Accumulation Value', 'Premium', 'Agent NPN', 'Policy Status',
  ],
  default_category: 'annuity',
}
...
const GLOBAL_ATLANTIC_FIA: CarrierFormatDefinition = {
  ...
  column_map: {
    ...
    'Premium': 'premium',
    'Account Value': 'account_value',
    'Net Surrender Value': 'surrender_value',
    'NPN': 'agent_npn',
    'Agent NPN': 'agent_npn',
    'Agent': 'agent_name',
    'Agent Name': 'agent_name',
    'State': 'state',
    'Surrender Charge End': 'maturity_date',
  },
  dedup_keys: ['policy_number', 'carrier_id'],
  header_signatures: [
    'Policy Number', 'Owner', 'Product', 'Issue Date',
    'Account Value', 'Premium Paid', 'NPN', 'Contract Status',
  ],
  default_category: 'annuity',
}
...
const GRADIENT_COMMISSION: CarrierFormatDefinition = {
  ...
  column_map: {
    ...
    'Owner Name': 'client_name',
    'Agent Name': 'agent_name',
    'Agent NPN': 'agent_npn',
    'NPN': 'agent_npn',
    'Gross Commission': 'gross_commission',
    'Commission Amount': 'gross_commission',
    ...
    'Premium': 'premium_basis',
    'Premium Amount': 'premium_basis',
    'Statement Period': 'statement_period',
    'Pay Period': 'statement_period',
  },
  dedup_keys: ['policy_number', 'transaction_date', 'commission_type'],
  header_signatures: [
...
const SIGNAL_COMMISSION: CarrierFormatDefinition = {
  ...
  column_map: {
    ...
    'Gross Commission': 'gross_commission',
    'Net Comm': 'net_commission',
    'Net Commission': 'net_commission',
    'Override': 'override_amount',
    'Split Percentage': 'split_pct',
    'Comm Type': 'commission_type',
    'Commission Type': 'commission_type',
    'Target Premium': 'premium_basis',
    'Premium': 'premium_basis',
  },
  dedup_keys: ['policy_number', 'transaction_date', 'commission_type'],
  header_signatures: [
...
export const CARRIER_FORMATS: CarrierFormatDefinition[] = [
  ...
  DST_VISION,
  MEDICARE_GENERIC,
  // DEVOUR Track (ZRD-D04) — expanded profiles
  CIGNA_MAPD,
  WELLCARE_MAPD,
  MUTUAL_OMAHA_MEDSUP,
  DEVOTED_MAPD,
