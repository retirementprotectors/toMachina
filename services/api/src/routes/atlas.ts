...
const WIRE_DEFINITIONS = [
  {
    ...
    stages: [
      ...
      { type: 'CLOUD_FUNCTION', name: 'mail-intake', project: 'services/intake' },
      { type: 'SCRIPT', name: 'watcher.js', detail: 'classify + extract' },
      { type: 'API_ENDPOINT', name: 'POST /api/approval', project: 'services/api' },
  ...
  },
  {
    ...
    stages: [
      ...
      { type: 'CLOUD_FUNCTION', name: 'email-intake', project: 'services/intake' },
      { type: 'SCRIPT', name: 'watcher.js', detail: 'OCR/AI extraction' },
      { type: 'MATRIX_TAB', name: '_REVENUE_MASTER', platform: 'RAPID' },
      { type: 'API_ENDPOINT', name: 'POST /api/cam/calculate', project: 'services/api' },
  ...
  },
  {
    ...
    stages: [
      ...
      { type: 'CORE_FUNCTION', name: 'normalizePhone', project: 'packages/core' },
      { type: 'MATRIX_TAB', name: '_CLIENT_MASTER', platform: 'RAPID' },
  ...
  },
  {
    ...
    stages: [
      { type: 'MATRIX_TAB', name: '_CLIENT_MASTER', platform: 'RAPID' },
      { type: 'API_ENDPOINT', name: 'POST /api/validation/phone', project: 'services/api' },
      { type: 'API_ENDPOINT', name: 'POST /api/validation/email', project: 'services/api' },
      { type: 'API_ENDPOINT', name: 'POST /api/validation/score', project: 'services/api' },
      { type: 'MATRIX_TAB', name: '_CLIENT_MASTER', platform: 'RAPID' },
    ],
  },
  ...
  },
  {
    ...
    stages: [
      ...
      { type: 'API_ENDPOINT', name: 'POST /api/import/accounts', project: 'services/api' },
      { type: 'CORE_FUNCTION', name: 'normalizeAccountData', project: 'packages/core' },
  ...
  },
  {
    ...
    stages: [
      ...
      { type: 'API_ENDPOINT', name: 'POST /api/leadership/meetings', project: 'services/api' },
