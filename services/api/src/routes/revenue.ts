...
import type { RevenueDTO, RevenueByAgentSummaryDTO, RevenueCreateDTO, RevenueUpdateDTO, RevenueBulkImportResult } from '@tomachina/core'
...
revenueRoutes.get('/summary/by-agent', async (req: Request, res: Response) => {
  try {
    ...
    res.json(successResponse<RevenueByAgentSummaryDTO>(summary as unknown as RevenueByAgentSummaryDTO, { pagination: { count: summary.length, total: summary.length } }))
  } catch (err) {
...
revenueRoutes.get('/:id', async (req: Request, res: Response) => {
  try {
    ...
    res.json(successResponse<RevenueDTO>(stripInternalFields({ id: doc.id, ...doc.data() } as Record<string, unknown>) as unknown as RevenueDTO))
  } catch (err) {
...
revenueRoutes.post('/', async (req: Request, res: Response) => {
  try {
    ...
    res.status(201).json(successResponse<RevenueCreateDTO>({ id: revenueId, ...data } as unknown as RevenueCreateDTO))
  } catch (err) {
...
revenueRoutes.patch('/:id', async (req: Request, res: Response) => {
  try {
    ...
    res.json(successResponse<RevenueUpdateDTO>(stripInternalFields({ id: updated.id, ...updated.data() } as Record<string, unknown>) as unknown as RevenueUpdateDTO))
  } catch (err) {
...
revenueRoutes.post('/bulk', async (req: Request, res: Response) => {
  try {
    ...
    res.json(successResponse<RevenueBulkImportResult>(summary as unknown as RevenueBulkImportResult))
  } catch (err) {
