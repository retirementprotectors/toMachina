...
app.use('/api/flow/admin', requireLevel('LEADER'), normalizeBody, flowAdminRoutes)
app.use('/api/flow', flowRoutes)
app.use('/api/templates', normalizeBody, templateRoutes)
app.use('/api/content-blocks', normalizeBody, contentBlockRoutes)
app.use('/api/atlas', requireLevel('EXECUTIVE'), normalizeBody, atlasRoutes)
...
app.use('/api/leadership', requireLevel('EXECUTIVE'), normalizeBody, leadershipRoutes)
...
app.use('/api/guardian', requireLevel('OWNER'), normalizeBody, guardianRoutes)
...
app.use('/api/config', requireLevel('OWNER'), normalizeBody, configRoutes)
app.use('/api/dashboard', dashboardRoutes)
app.use('/api/mdj', normalizeBody, mdjRoutes)
app.use('/api/notifications', notificationRoutes)
app.use('/api/validation', validationRoutes)
app.use('/api/import-agents', normalizeBody, importAgentRoutes)
app.use('/api/voltron/registry', requireLevel('LEADER'), voltronRegistryRoutes)
app.use('/api/voltron/wire', requireLevel('LEADER'), normalizeBody, voltronWireRoutes)
app.use('/api/voltron/cases', requireLevel('LEADER'), normalizeBody, voltronCasesRoutes)
app.use('/api/voltron/gap-requests', normalizeBody, voltronGapRequestRoutes)
app.use('/api/voltron', requireLevel('LEADER'), normalizeBody, voltronDeployRoutes)
...
app.use('/api/rangers', requireLevel('EXECUTIVE'), normalizeBody, rangerRoutes)

// MUSASHI CMO — Wire execution, intake, pipeline status (MUS-O05/O09/O10)
app.use('/api/cmo', requireLevel('EXECUTIVE'), normalizeBody, cmoWireRoutes)
app.use('/api/cmo', requireLevel('EXECUTIVE'), normalizeBody, cmoIntakeRoutes)
app.use('/api/cmo', requireLevel('EXECUTIVE'), normalizeBody, cmoPipelineRoutes)
app.use('/api/cmo', requireLevel('EXECUTIVE'), normalizeBody, cmoEventRoutes)
app.use('/api/cmo', requireLevel('EXECUTIVE'), normalizeBody, cmoDashboardRoutes)
