...
async function getCalendarAuth(userEmail) {
    ...
    const metaToken = (await metadataRes.json()).access_token;
    const signRes = await fetch(`https://iamcredentials.googleapis.com/v1/projects/-/serviceAccounts/${SA_EMAIL}:signJwt`, {
        method: 'POST',
...
//# sourceMappingURL=calendar-busy-sync.js.map