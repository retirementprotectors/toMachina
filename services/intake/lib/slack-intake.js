...
import { routeToRanger, isAutoDispatchable } from './wire-router.js';
 ...
 */
export async function processSlackIntake(message) {
    const result = {
        success: true,
        files_received: 0,
        files_dispatched: 0,
 ...
 */
export function getMegazordIntakeChannel() {
    return MEGAZORD_INTAKE_CHANNEL;
}
//# sourceMappingURL=slack-intake.js.map