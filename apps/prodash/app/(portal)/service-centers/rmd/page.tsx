  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-6 flex flex-col items-center justify-center rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] py-20">
        <span className="material-icons-outlined text-5xl text-[var(--text-muted)]">calendar_month</span>
        <p className="mt-4 text-sm text-[var(--text-muted)]">Required Minimum Distribution tracking and management — coming soon.</p>
      </div>
    </div>
  )
}
