  ...
  return (
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-6 flex flex-col items-center justify-center rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] py-20">
        <span className="material-icons-outlined text-5xl text-[var(--text-muted)]">savings</span>
        <p className="mt-4 text-sm text-[var(--text-muted)]">Annuity quoting and illustration tools — coming soon.</p>
      </div>
    </div>
  )
}
