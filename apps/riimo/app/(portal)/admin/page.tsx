...
export default function AdminPage() {
  const { data: users, loading, error } = useCollection<UserRecord>(usersQuery, 'admin-users')
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <h1 className="text-2xl font-bold text-[var(--text-primary)]">Admin</h1>
      <p className="mt-1 text-sm text-[var(--text-muted)]">User management and portal administration</p>
