...
export const WIRE_BROCHURE: CmoWireDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      inputSchemaRef: '{ renderedPdfUrl: string, market: string, product: string }',
