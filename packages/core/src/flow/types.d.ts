...
export type ActivityAction = 'CREATE' | 'ADVANCE_STAGE' | 'ADVANCE_STEP' | 'COMPLETE_TASK' | 'SKIP_TASK' | 'GATE_PASS' | 'GATE_FAIL' | 'ASSIGN' | 'PRIORITY_CHANGE' | 'SYSTEM_CHECK';
export type BuiltInCheckType = 'FIELD_PRESENT' | 'FIELD_MATCHES' | 'FIELD_NOT_CONTAINS' | 'NUMERIC_LIMIT' | 'ALL_FORMS_CHECKED' | 'MANUAL';
...
export type CheckHandler = (checkConfig: Record<string, unknown>, instanceData: Record<string, unknown>) => CheckHandlerResult;
