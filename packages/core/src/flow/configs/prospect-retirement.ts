...
const pipeline: FlowPipelineDef = {
  pipeline_key: 'PROSPECT_RETIREMENT',
  pipeline_name: 'Prospecting - Retirement',
  description: 'Retirement prospecting pipeline. Simple Kanban with connect attempts. Hands off to Sales Process - Retirement.',
  portal: 'PRODASHX',
  domain: 'RETIREMENT',
  default_view: 'kanban',
  icon: 'person_search',
...
const stages: FlowStageDef[] = [
  {
    ...
    stage_id: 'new_lead',
    stage_name: 'New Lead',
    stage_description: 'New lead received. Initial qualification pending.',
    stage_order: 10,
    stage_color: 'gray',
    gate_enforced: false,
    has_workflow: true,
  ...
  },
  {
    ...
    stage_description: 'Prospect converted. Handoff to Sales Process - Retirement.',
    stage_order: 60,
    stage_color: 'green',
    gate_enforced: false,
    has_workflow: true,
...
const workflows: FlowWorkflowDef[] = [
  {
    ...
    workflow_description: 'Initial lead qualification.',
    status: 'active',
  },
  {
    pipeline_key: 'PROSPECT_RETIREMENT',
  ...
  },
  {
    ...
    workflow_description: 'Prospect converted — prepare handoff.',
    status: 'active',
  },
]
...
const steps: FlowStepDef[] = [
  {
    ...
    step_description: 'Review and qualify the new lead.',
    step_order: 10,
    gate_enforced: false,
  ...
  },
  {
    ...
    step_description: 'Make initial contact with the lead.',
    step_order: 10,
    gate_enforced: false,
    execution_type: 'manual',
    status: 'active',
...
const tasks: FlowTaskTemplateDef[] = [
  {
    ...
    task_description: 'Review lead source and qualification criteria.',
    task_order: 10,
    is_required: false,
...
export const PROSPECT_RETIREMENT_CONFIG = {
  pipeline,
  stages,
  workflows,
  steps,
