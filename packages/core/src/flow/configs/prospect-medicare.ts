...
const pipeline: FlowPipelineDef = {
  pipeline_key: 'PROSPECT_MEDICARE',
  pipeline_name: 'Prospecting - Medicare',
  description: 'Medicare prospecting pipeline (formerly Pre-Sales). Mirrors Retirement prospecting. Hands off to Sales Process - Medicare.',
  portal: 'PRODASHX',
  domain: 'MEDICARE',
  default_view: 'kanban',
  icon: 'person_search',
  handoff_pipeline: 'SALES_MEDICARE',
  status: 'active',
...
const stages: FlowStageDef[] = [
  {
    ...
    stage_id: 'new_lead',
    stage_name: 'New Lead',
    stage_description: 'New Medicare lead received. Initial qualification pending.',
    stage_order: 10,
    stage_color: 'gray',
    gate_enforced: false,
    has_workflow: true,
  ...
  },
  {
    ...
    stage_description: 'Prospect converted. Handoff to Sales Process - Medicare.',
    stage_order: 60,
    stage_color: 'green',
    gate_enforced: false,
    has_workflow: true,
...
const workflows: FlowWorkflowDef[] = [
  {
    ...
    workflow_description: 'Initial Medicare lead qualification.',
    status: 'active',
  },
  {
    pipeline_key: 'PROSPECT_MEDICARE',
  ...
  },
  {
    ...
    workflow_description: 'Prospect converted — prepare handoff to Medicare Sales.',
    status: 'active',
  },
]
...
const steps: FlowStepDef[] = [
  {
    ...
    step_description: 'Review and qualify the new Medicare lead.',
    step_order: 10,
    gate_enforced: false,
  ...
  },
  {
    ...
    step_description: 'Make initial contact with the Medicare lead.',
    step_order: 10,
    gate_enforced: false,
    execution_type: 'manual',
    status: 'active',
  ...
  },
  {
    ...
    step_description: 'Prepare handoff to Sales Process - Medicare.',
    step_order: 10,
    gate_enforced: false,
    execution_type: 'manual',
    status: 'active',
...
const tasks: FlowTaskTemplateDef[] = [
  {
    ...
    task_description: 'Review Medicare lead source and qualification criteria.',
    task_order: 10,
    is_required: false,
  ...
  },
  {
    ...
    task_description: 'Trigger handoff to SALES_MEDICARE pipeline.',
    task_order: 10,
    is_required: true,
    is_system_check: false,
    default_owner: 'ADVISOR',
...
export const PROSPECT_MEDICARE_CONFIG = {
  pipeline,
  stages,
  workflows,
  steps,
