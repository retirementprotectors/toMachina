...
export const AccountSchema = v.objectWithRest({ id: v.string(), account_type: v.string(), carrier: v.optional(v.string()), status: v.string(), created_at: v.string(), updated_at: v.string() }, v.unknown())
